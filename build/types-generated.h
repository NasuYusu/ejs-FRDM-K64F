...
#define HTAG_STRING ((HTag) {(cell_type_t) CELLT_STRING})
#define HTAGV_FLONUM 5
#define HTAG_FLONUM ((HTag) {(cell_type_t) CELLT_FLONUM})
#define HTAGV_SIMPLE_OBJECT 6
#define HTAG_SIMPLE_OBJECT ((HTag) {(cell_type_t) CELLT_SIMPLE_OBJECT})
#define HTAGV_ARRAY 7
#define HTAG_ARRAY ((HTag) {(cell_type_t) CELLT_ARRAY})
#define HTAGV_FUNCTION 8
#define HTAG_FUNCTION ((HTag) {(cell_type_t) CELLT_FUNCTION})
#define HTAGV_BUILTIN 9
#define HTAG_BUILTIN ((HTag) {(cell_type_t) CELLT_BUILTIN})
#define HTAGV_ITERATOR 10
#define HTAG_ITERATOR ((HTag) {(cell_type_t) CELLT_ITERATOR})
#define HTAGV_REGEXP 11
#define HTAG_REGEXP ((HTag) {(cell_type_t) CELLT_REGEXP})
#define HTAGV_BOXED_STRING 12
#define HTAG_BOXED_STRING ((HTag) {(cell_type_t) CELLT_BOXED_STRING})
#define HTAGV_BOXED_NUMBER 13
#define HTAG_BOXED_NUMBER ((HTag) {(cell_type_t) CELLT_BOXED_NUMBER})
#define HTAGV_BOXED_BOOLEAN 14
#define HTAG_BOXED_BOOLEAN ((HTag) {(cell_type_t) CELLT_BOXED_BOOLEAN})
