...
#define PRINT_MEM_USAGE(f) \
  printf("after " #f " used = %ld\n\r", js_space.bytes - js_space.free_bytes);
...
//#else /* JS_SPACE_BYTES */
//int heap_limit = 10 * 1024 * 1024;
int heap_limit = 159360;
